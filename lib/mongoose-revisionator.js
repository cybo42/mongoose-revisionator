...
//
    ...
    schema.static('findRevisionById', function(revisionId, callback){
      VersionModel.findById(revisionId, callback);
    });
    ...
    schema.method('findRevisions', function(criteria, callback){
      ...
      //TODO: add support for sort, start, skip, limit to be passed in
      VersionModel.find(query).sort("-modified").exec(callback);
